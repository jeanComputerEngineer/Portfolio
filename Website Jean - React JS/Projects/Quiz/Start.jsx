...
import Quiz from '../../Images/Projects/Quiz/QuizLogo.png';
...
const Start = () => {
  ...
  return (
    <div className={styles.containerStart}>
      ...
      <h2>
        AVISO: Este quiz contém ironia, então tudo que estiver incluso é proposital para a
        realização da crítica e mensagem final do autor.
      </h2>
