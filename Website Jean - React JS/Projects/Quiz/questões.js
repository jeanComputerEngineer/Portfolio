const data = [
  {
    ...
    retorno:
      'Infelizmente você não é o melhor, não vai dar nem pro cheiro pra concorrência no futuro.',
  },
  {
  ...
  },
  {
    ...
    options: ['Linda e rica', 'Feia e rica', 'Linda e pobre', 'Pobre e feia'].sort(
      () => Math.random() - 0.5,
    ),
    answer: 'Linda e rica',
