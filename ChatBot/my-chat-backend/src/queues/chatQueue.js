...
exports.chatQueue = new bull_1.default('chatQueue', {
    redis: { host: 'localhost', port: 6379 },
});
// Processa cada job da fila
exports.chatQueue.process(function (job) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, messages, model, requestBody, fetch, response, data;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = job.data, messages = _a.messages, model = _a.model;
                requestBody = {
