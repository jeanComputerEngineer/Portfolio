...
export default function ChatPageComponent({
    ...
    const [, setUser] = useState<{ name: string; preferredLanguage: string } | null>(
        null
    );
    ...
    return (
        <ProtectedRoute>
          ...
          `}
                ...
                <section
                    className="flex flex-col w-full h-full md:ml-0 md:static max-h-[83vh]"
                >
                    <div className="p-4">
                        <select
                            value={model}
                    ...
                    >
                        {messages.length === 0 ? (
                            <div className="mb-3 w-full">
                                <p className="text-sm">
                                    {t("sugestoes") || "Recomendações de prompt:"}
                                </p>
                    ...
                    {errorMessage && (
                        <div
                            className="mx-4 mb-4 p-2 bg-red-100 text-red-600 rounded-md text-sm"
                            role="alert"
                        >
                            {errorMessage}
                        </div>
